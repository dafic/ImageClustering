...
public class Image {
	...
	public static MixtureModel loadMixtureModel(String path, BufferedImage image, int n){
            //System.out.println("LoadMixtureModel starts");
		MixtureModel mm = MixtureModel.load(path);
		if (mm==null){
                    //System.out.println("createImageFromMixtureModel starts");
			...
			MixtureModel.save(mm, path);
                        //System.out.println("createImageFromMixtureModel ends");
		}
                System.out.println("LoadMixtureModel completes");
		return mm;
	}
	...
	public static BufferedImage createImageFromMixtureModel(int width, int height, MixtureModel mm){
		...
		while (min(imgCpt, height, width)<10){
			...
			// Fill the imgSum
			for (int i=0; i<n; i++){
                                //System.out.println("dimension array["+i+"]= "+pixels[i].dim);
		...
		System.out.println("createImageFromMixtureModel completes");
		// Return
		return imgOut;
	}
