...
public class Image {
    ...
    public static MixtureModel getGMM(BufferedImage image, int n) throws IOException {
        ...
        //byte[] bytesArray= ObjectToByte.objectToByteArray(mm.getSerializable());
        //System.out.println("bytes are"+bytesArray.toString());
        ///return bytesArray;
        return mm;

    }
    public static byte[] getGMMByte(BufferedImage img,int n) throws IOException{
        MixtureModel model=Image.getGMM(img, n);
        //return ObjectToByte.objectToByteArray(model.getSerializable());
        return ObjectAndByte.objectToByteArray(model);
    }
