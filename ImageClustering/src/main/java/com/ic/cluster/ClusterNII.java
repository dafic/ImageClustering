 ...
 * @author phoenix
 */
public class ClusterNII extends Configured implements Tool {
    ...
    public static class ClusterMapper extends Mapper<Text, Text, ImmutableBytesWritable, Writable> {
        ...
        protected void map(Text key, Text value, Context context) throws IOException, InterruptedException {
            ...
            if (keyString.contains(",")) {
                ...
                System.out.println("<list:start>combined following:");
...
//                byte[] writableGMMBinaryData = Bytes.toBytes(Bytes.toStringBinary(resultGMMBinaryData));
                ...
                byte[] rowkey = Bytes.toBytes(newLevel + "|" + DigestUtils.md5Hex(keyString));
...
//                put.add(family, gmmQualifier, writableGMMBinaryData);
                ...
                System.out.println("single key only:"+keyString);
...
//                MixtureModel m = co1.getGmm();//MixtureModel m = Util.getMixtureModel(keyString);
                ...
                byte[] rowkey = Bytes.toBytes(newLevel + "|" + keyString.substring(keyString.indexOf("|")+1));
//
...
//        String inputFileName = "/cluster/lookup.seq";
