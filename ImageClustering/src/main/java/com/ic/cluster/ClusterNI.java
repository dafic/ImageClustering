 ...
 * @author phoenix
 */
public class ClusterNI extends Configured implements Tool {
    ...
    public int run(String[] strings) throws Exception {
        ...
        try {
            ...
            while (reader.next(k, v)) {
                ...
                readValue = readValue.substring(0, readValue.length()); //remove last comma
...
//                        System.out.println("dist is ok");
                        ...
                        newRecordValue = newRecordValue.substring(0, newRecordValue.length());
